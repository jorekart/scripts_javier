...
from cherab.core.atomic import neon, hydrogen, argon
...
Te_max = 40   #rates_recom[1].raw_data["te"].max()
...
plt.legend()
plt.savefig('Neon_charge_distribution.png')
...
plt.legend()
plt.savefig('Neon_average_charge.png')
...
plt.grid(True)
plt.xlabel("Electron Temperature (eV)")
plt.title('Z_eff of Neon')
plt.legend()
plt.savefig('Neon_Zeff.png')
...
plt.legend()
plt.savefig('Neon_ne.png')


# Plot Lrad 
plt.figure()
plt.semilogx(Te_array,Lrad,  label=label1)
plt.semilogx(Te_array,Lrad2, label=label2)
plt.grid(True)
plt.xlabel("Electron Temperature (eV)")
plt.title('Radiation power')
plt.legend()
plt.savefig('Neon_Lrad.png')
...
plt.legend()
plt.savefig('Neon_eta_Spitzer.png')
