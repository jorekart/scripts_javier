...
program analyze_T_rise
  ...
  integer :: i_begin=100, i_end=99900, i_step, i_jump_steps=100
  ...
  do i_step = i_begin, i_end, i_jump_steps
    ...
    write(file_name,'(a,i6.6,a)')   'heatload_3D_wall.', i_step, '.dat'
  ...
  do i=1, n_tri
    ...
    write(78, '(8ES14.6)') tri_phi, tri_theta, T_max(i), melt_duration(i), E_dep(i)*tri_areas(i), tri_areas(i), tri_R, tri_Z
