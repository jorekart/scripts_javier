...
info = {}
info['status']          = 'active'
info['comment']         = 'IDM documents 2PN3CN, 2MZWJR'
info['workflow']        = 'DINA ITER Disruption Simulator-2010'
info['REmax']           = 0
info['machine']         = 'ITER'
...
for case in shot_list:
    ...
    # ne0
    try:
        ne0 = input.partial_get('summary','volume_average/n_e/value')
        central_electron_density = ne0[0]   
    except:
        print("summary','volume_average/n_e/value", file=sys.stderr)
        ne0 = 0
    ...
    if 'up' in info['name'].lower():
        VD_direction = 'up' 
    elif 'dw' in info['name'].lower():
        VD_direction = 'down'
    else:
        VD_direction = 'tbd' 
